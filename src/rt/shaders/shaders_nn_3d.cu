...
extern "C" __constant__ hd::details::LaunchParamsNN<FLOAT_TYPE, 3> params;

extern "C" __global__ void __intersection__nn_3d() {
  ...
  FLOAT_TYPE min_z = point_b.z - radius;
  FLOAT_TYPE max_z = point_b.z + radius;
...
extern "C" __global__ void __anyhit__nn_3d() { optixTerminateRay(); }

extern "C" __global__ void __raygen__nn_3d() {
