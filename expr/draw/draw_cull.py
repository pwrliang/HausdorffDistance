...
def parse_vary_dist(prefix, filter):
    time = []
...
def draw_vary_dist(prefix):
    df = parse_vary_dist(prefix, "cull_true")
    ...
    fig.savefig("cull_true.png", format='png', bbox_inches='tight')
    plt.show()


if __name__ == '__main__':
    dir = os.path.dirname(sys.argv[0]) + "/../logs/cull"
