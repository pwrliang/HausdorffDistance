...
function vary_dist() {
  LIMIT=1000000
  for variant in serial parallel gpu rt lbvh; do
    for file1 in "${DATASETS1[@]}"; do
      for file2 in "${DATASETS2[@]}"; do
        for dist in 0.1 0.2 0.4 0.8 1.6 3.2 6.4 12.8 25.6 51.2 102.4; do
          log="${log_dir}/vary_dist/${variant}_${file1}_${file2}_dist_${dist}_limit_$LIMIT.log"
